...
const Movement: React.FC = () => {
  return (
    <div className="relative ml-9 md:ml-0   ">
        ...
        <Link to="/">
                      <span className="block z-50 md:hidden">sosioloji</span>
                    </Link>
      ...
      {/* Main Tag Container */}
      <div
        className="relative w-full bg-[#FFF0D3] flex items-center justify-center rounded-[15px] shadow-md p-4 md:h-[400px] h-auto"
        id="tag-box"
      >
        ...
        <div className="flex flex-wrap space-x-3 items-center w-full">
          ...
          <form className="subscribe-form mt-4" data-members-form="subscribe">
            <h5 className="text-2xl md:text-4xl text-center mb-4 md:mb-7 font-bold">Join The Movement</h5>
            <div className="form-group">
              ...
              <input
                type="email"
                name="email"className="w-full mt-4 mb-3 px-7 py-3 pf text-gray-700 bg-white border border-gray-300 rounded-3xl text-sm outline-none focus:ring-0 focus:ring-pink-300 transition"
                required
