  ...
  return (
    <section className="min-h-screen flex items-center justify-center flex-col py-12 px-4 ">
      ...
      <div className="max-w-7xl w-full mx-auto px-4  md:px-8">
        <div className="flex flex-col md:flex-row gap-10 md:max-h-screen items-center justify-between">
          {/* TEXT SECTION (1st on mobile, 2nd on desktop) */}
          <div className="w-full h-full border-l md:w-1/2 p-6 order-1 md:order-2">
          ...
          {/* FORM SECTION (2nd on mobile, 1st on desktop) */}
          <div className="max-w-7xl  mx-auto px-8 md:px-12">
            <div className="relative ml-9 md:ml-0   ">
              ...
              {/* Main Tag Container */}
              <div
                className="relative w-full bg-[#FFF0D3] flex items-center justify-center rounded-[15px] shadow-md p-4 sm:h-[400px] h-auto"
                id="tag-box"
              >
