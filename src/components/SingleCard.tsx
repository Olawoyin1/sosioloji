      ...
      <div className="flex flex-col justify-center items-center max-w-[500px] max-h-[590px] md:max-h-[590px]">
        ...
        >
          ...
          >
            <Link
              // to={`/post/${item.slug}`}
              to={item.category === "Survey" ? `/survey/${item.slug}` : `/post/${item.slug}`}
        ...
        <div className="mt-4  md:mt-10">
          <div className="mb-5">
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div className="h-8 w-8 overflow-hidden bg-black/30 text-white flex justify-center items-center rounded-full">
                  <img
