    ...
    <div className="flex flex-col justify-center items-center max-w-[500px] max-h-[500px]">
      ...
      >
        ...
        >
          ...
          <div className={`absolute top-1/2 left-0 -translate-y-1/2 ${isMobile ? "translate-x-[-61px]" : "-translate-x-[61px]"} flex flex-col gap-3 pointer-events-auto`}>
            <div className={`w-[120px] h-[30px] bg-[#E8D4C3] border border-black rounded-full flex justify-center items-center ${isMobile ? "-rotate-90" : "-rotate-90"}`}>
              <Link
                to={item.categoryLink}
                className="text-[#444] font-semibold text-sm no-underline"
              >
      ...
      <div className="pt-[24px] h-[200px]">
        <div className="mb-5">
          ...
          <p className="text-base text-gray-700 mb-1">{item.description}</p>
          <FancyLinkButton
            label={item.buttonLabel}
            to={item.buttonLink}
            bgColor={item.buttonBgColor}
