  ...
  return (
     <div className="tags-widget max-w-[500px]">
      ...
      <div className="wrapper-tag-widget">
        <div className="absolute top-[-20px] left-5  bg-[#FFF0D3] shadow-md p-4 rounded-[15px] space-x-4 space-y-10 flex-wrap justify-center  items-center h-[330px] max-w-[400px] w-full">
            {tags.map((tag) => (
              <FancyLinkButton
                key={tag.label}
              label={tag.label}
